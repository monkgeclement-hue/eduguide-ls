...
See [RELEASE_NOTES.md](RELEASE_NOTES.md) for the latest security fixes and manual Render deployment notes.
...
- Matching Engine v2 using the 262-record catalogue (232 approved and 30 awaiting review), inferred domains, eligibility checks, funding readiness, institution-grouped results, and data-confidence warnings
